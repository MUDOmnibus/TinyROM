...
#define ACT_STAY_AREA      (C)   /* Won't leave area   */
#define ACT_WIMPY          (D) 
#define ACT_PET            (E)   /* Auto set for pets  */
#define ACT_TRAIN          (F)   /* Can train PC's     */
#define ACT_PRACTICE       (G)   /* Can practice PC's  */
#define ACT_NOALIGN        (H) 
#define ACT_NOPURGE        (I)
#define ACT_OUTDOORS       (J)
#define ACT_INDOORS        (K)
#define ACT_GAIN           (L)
#define ACT_UPDATE_ALWAYS  (M)
#define ACT_IS_CHANGER     (N)
...
#define ASSIST_ALL         (D)
#define ASSIST_ALIGN       (E)
#define ASSIST_RACE        (F)
#define ASSIST_PLAYERS     (G)
#define ASSIST_VNUM        (H)
...
#define FORM_INSTANT_DECAY      (B)
 
/* body parts */
#define PART_HEAD               (A) // Severable
#define PART_ARMS               (B) // Severable
#define PART_LEGS               (C) // Severable
#define PART_HEART              (D) // Severable
#define PART_BRAINS             (E) // Severable
#define PART_GUTS               (F) // Severable
...
#define OBJ_VNUM_SCHOOL_SWORD      1
 ...
 */
#define ITEM_TRASH       1
#define ITEM_PORTAL      2
#define ITEM_CONTAINER   3
#define ITEM_ARMOR       4
#define ITEM_CLOTHING    5
#define ITEM_WEAPON      6
#define ITEM_LIGHT	 7
#define ITEM_FOOD        8
#define ITEM_FOUNTAIN    9
#define ITEM_DRINK_CON   10
#define ITEM_FURNITURE   11
 ...
 * Used in #OBJECTS.
 */
#define ITEM_NODROP        (A)
#define ITEM_NOREMOVE      (B)
#define ITEM_INVENTORY     (C)
#define ITEM_NOPURGE       (D)
#define ITEM_ROT_DEATH     (E)
#define ITEM_VIS_DEATH     (F)
#define ITEM_MELT_DROP     (G)
#define ITEM_SELL_EXTRACT  (H)
 ...
 */
#define ITEM_TAKE         (A)
#define ITEM_WEAR_RELIC   (B)
#define ITEM_WEAR_HEAD    (C)
#define ITEM_WEAR_CLOTHES (D)
#define ITEM_WEAR_ARMOR   (E)
#define ITEM_WEAR_SHIELD  (F)
#define ITEM_WIELD        (G)
#define ITEM_HOLD         (H)
...
/* weapon types */
#define WEAPON_TWO_HANDS  (A)

/* gate flags */
#define GATE_NORMAL_EXIT  (A) 
#define GATE_GOWITH       (B)
 ...
 */
#define WEAR_NONE    -1
#define WEAR_RELIC_1  0
#define WEAR_RELIC_2  1
#define WEAR_HEAD     2
#define WEAR_CLOTHES  3
#define WEAR_ARMOR    4
#define WEAR_SHIELD   5
#define WEAR_WIELD    6
#define WEAR_HOLD     7
#define MAX_WEAR      8
